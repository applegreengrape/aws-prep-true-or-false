        ...
        <div>
          <div className="flex flex-col items-center text-base p-4 text-gray-100 font-mono">
            <div className="p-8">
              ...
              <a
                className="underline"
                href="https://www.udemy.com/course/aws-solutions-architect-professional-practice-exams-amazon/#instructor-1"
              >
                Jon Bonso | AWS Certified Solutions Architect Professional
                Practice Exam.
              </a>{" "}
              🎩 Hats off to Jon Bonso, his practice test is amazing!
            </div>
            <button
              type="button"
